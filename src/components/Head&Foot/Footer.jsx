...
const Footer = () => {
    return (
        <div className="h-60 ">
            <footer className="px-4 pt-10  divide-y py-1 dark:bg-indigo-700 ">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 pb-8 border-b-2 border-gray-200">
                        <div className="flex flex-col gap-8 xl:gap-10 w-full lg:max-w-full mx-auto">
                            <div className="flex flex-col gap-8">
                                ...
                                <p className="text-base font-normal text-white max-[470px]:text-center">
                                    Take the First Step Towards Success!
                                </p>
                                <div className="flex items-center max-[470px]:justify-center gap-5">
                                    <a
                                        href="javascript:;"
                                        className="p-2 text-white rounded transition-all duration-500 hover:bg-indigo-500 focus-within:bg-indigo-500 hover:text-white focus-within:outline-0 focus-within:text-white"
                                    >
                                        <svg
                                    ...
                                    <a
                                        href="javascript:;"
                                        className="p-2 h-10 w-10 flex items-center justify-center text-white rounded transition-all duration-500 hover:bg-indigo-500 focus-within:outline-0 focus-within:bg-indigo-500 hover:text-white focus-within:text-white"
                                    >
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            width={22}
                        ...
                        <div className="w-full lg:max-w-full mx-auto flex flex-col min-[470px]:flex-row justify-between gap-6 sm:gap-20 md:gap-10 xl:gap-24">
                            <div className="">
                                <h6 className="text-lg font-medium text-white mb-7 max-[470px]:text-center">
                                    Pages
                                </h6>
                                <ul className="flex flex-col max-[470px]:items-center max-[470px]:justify-center gap-6">
                                    <li>
                                        <a
                                            href="javascript:;"
                                            className="text-base font-normal max-lg:text-center text-white whitespace-nowrap transition-all duration-300 hover:text-indigo-300 focus-within:outline-0 focus-within:text-indigo-300"
                                        >
                                            Home
                                        </a>
                                    </li>
                    ...
                    <div className="flex flex-col-reverse gap-5 sm:flex-row items-center first-letter:items-center justify-between pt-7">
                        ...
                        <ul className="flex items-center gap-9">
                            <li>
                                <a
                                    href="javascript:;"
                                    className="text-white text-sm font-normal transition-all duration-300 hover:text-indigo-300 focus-within:outline-0 focus-within:text-indigo-300"
                                >
                                    Terms
                                </a>
                            </li>
