...
const Footer = () => {
    return (
        <div className="h-60 ">
            <footer className="px-4 pt-10  divide-y py-1 dark:bg-stone-200 dark:text-gray-800">
                <div className="mx-auto  max-w-7xl px-4 sm:px-6 lg:px-8 ">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 pb-8 border-b-2 border-gray-200">
                        <div className="flex flex-col gap-8 xl:gap-10 w-full lg:max-w-full mx-auto">
                            <div className="flex flex-col gap-8">
                                ...
                                <div className="flex items-center max-[470px]:justify-center gap-5">
                                    <a
                                        href="javascript:;"
                                        className="p-2 text-black rounded transition-all duration-500 hover:bg-green-500 focus-within:bg-green-500 hover:text-white focus-within:outline-0 focus-within:text-white"
                                    >
                                        <svg
                                    ...
                                    <a
                                        href="javascript:;"
                                        className="p-2 h-10 w-10 flex items-center justify-center text-black rounded transition-all duration-500 hover:bg-green-500 focus-within:outline-0 focus-within:bg-green-500 hover:text-white focus-within:text-white"
                                    >
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            width={22}
                                    ...
                                    <a
                                        href="javascript:;"
                                        className="p-2 text-black group rounded transition-all duration-500 hover:bg-green-500 focus-within:bg-green-500 hover:text-white focus-within:outline-0 focus-within:text-white"
                                    >
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            width={24}
                            ...
                            {/* <div className="flex  flex-col min-[470px]:flex-row min-[470px]:items-center gap-3">
                                <button className="flex items-center max-[470px]:justify-center gap-2 py-3 pr-5 pl-7 rounded-full text-base font-semibold text-white bg-green-500 shadow-transparent shadow-sm transition-all duration-500 hover:shadow-yellow-300 hover:bg-green-800">
                                    Start Project
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width={20}
                                ...
                                <button className="flex items-center max-[470px]:justify-center gap-2 border-2 border-green-800 py-2.5 pr-5 pl-7 rounded-full text-base font-semibold text-green-500 bg-white shadow-transparent shadow-sm transition-all duration-500 hover:shadow-yellow-300 hover:bg-green-500 hover:text-white ">
                                    Contact Us
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width={20}
                    ...
                    <div className="flex flex-col-reverse gap-5 sm:flex-row items-center first-letter:items-center justify-between pt-7">
                        ...
                        <ul className="flex items-center gap-9">
                            <li>
                                <a
                                    href="javascript:;"
                                    className="text-gray-500 text-sm font-normal transition-all duration-300 hover:text-green-500 focus-within:outline-0 focus-within:text-green-500"
                                >
                                    Terms
                                </a>
                            </li>
